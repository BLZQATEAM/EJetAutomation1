...
import com.bridgelabz.ejet.pages.registerwebsiteuser.Email_Id;
...
public class Email_Id_Test extends ReadWebinarPropertiesFile {
    Email_Id email_id;
    ...
    public void valid_Email_Id_Test() throws InterruptedException {
        boolean msg=email_id.valid_Email_Id(prop.getProperty("Valid_EmailId"));
